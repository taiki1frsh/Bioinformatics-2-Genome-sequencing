/* 
This file is derived from https://github.com/TianyiShi2001/Algorithms/blob/main/src/graph/eulerian_path.rs
The simple explanation of this algo is first make the stack that has edge still,
second put node to circuit that doesn't have edge anymore, 
and finally reverse the content of circuit.
*/

use crate::w2::data_structure::UnweightedAdjacencyList;
